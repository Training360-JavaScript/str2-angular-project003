...
## Előkészítés
- A csapat egyik lépjen be a classroom-ba és hozza létre a team-et.
- Klónozza le a repo-t ami létrejön és hozza létre a branch-eket a tagoknak.
- (Itt jobb lehet emberenként létrehozni a branch-eket, nem fájlonként.)
- A többiek is lépjenek be az adott csapatba és klónozzák a repo-t.
